 ...
 */
public class VRule extends UIElement{


    public VRule() {
        super();
        super.getControlAttributes().get("controlTypeID").setPropertyValue("com.balsamiq.mockups::VRule");         
    ...
    public String toString() {
        return super.toString() + "\nVRule{" + "backgroundAlpha=" + super.getControlNodes().get("backgroundAlpha") + ", " + "color=" + super.getControlNodes().get("color") + ", " + "stroke=" + super.getControlNodes().get("stroke") + "}";
    }
}