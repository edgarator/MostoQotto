 ...
 */
public class ModalScreen extends UIElement{


    public ModalScreen() {
        super();
        super.getControlAttributes().get("controlTypeID").setPropertyValue("com.balsamiq.mockups::ModalScreen");         
    ...
    public String toString() {
        return super.toString() + "\nModalScreen{" + "map=" + super.getControlNodes().get("map") + ", " + "href=" + super.getControlNodes().get("href") + "}";
    }
}