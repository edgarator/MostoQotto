 ...
 */
public class HCurly extends UIElement{


    public HCurly() {
        super();
        super.getControlAttributes().get("controlTypeID").setPropertyValue("com.balsamiq.mockups::HCurly");         
