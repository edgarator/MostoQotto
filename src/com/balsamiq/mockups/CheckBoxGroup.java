 ...
 */
public class CheckBoxGroup extends UIElement{


    public CheckBoxGroup() {
        super();
        super.getControlAttributes().get("controlTypeID").setPropertyValue("com.balsamiq.mockups::CheckBoxGroup");         
