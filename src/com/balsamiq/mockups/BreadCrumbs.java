...
public class BreadCrumbs extends UIElement{
    ...
    public BreadCrumbs() {
        super();
        super.getControlAttributes().get("controlTypeID").setPropertyValue("com.balsamiq.mockups::BreadCrumbs");         
    ...
    public String toString() {
        return super.toString() + "\nBreadCrumbs{" + "bold=" + super.getControlNodes().get("bold") + ", " + "italic=" + super.getControlNodes().get("italic") + ", " + "map=" + super.getControlNodes().get("map") + ", " + "size=" + super.getControlNodes().get("size") + ", " + "text=" + super.getControlNodes().get("text") + ", " + "underline=" + super.getControlNodes().get("underline") + ", " + "hrefs=" + super.getControlNodes().get("hrefs") + "}";
    }
}